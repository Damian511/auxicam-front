  ...
  <v-container fluid>
    ...
    <v-footer color="blue-grey darken-1" padless absolute>
      <v-row justify="center" no-gutters>
        ...
        <v-btn color="white" text class="my-2" @click="dialog = true"
          >Estado del Dispositivo</v-btn
        >
        <v-col
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <v-row class="mt-1">
            <v-col>
              <v-alert type="warning" dense v-if="selectDispositivo == ''"
                >Seleccione un dispositivo para ver el estado</v-alert
              >
            </v-col>
          </v-row>
          <v-row>
